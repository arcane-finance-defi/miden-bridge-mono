...
6. Find Miden token wrapper address for your EVM token (for Sepolia USDC it's 0xd354f13600df2920000c682da84a64), this wrapper address is also a FAUCET_ID for the next step.
